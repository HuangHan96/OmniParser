...
def parse_arguments():
    ...
    parser.add_argument('--device', type=str, default='auto', choices=['auto', 'cpu', 'cuda', 'mps'], help='Device to run the model')
    parser.add_argument('--BOX_TRESHOLD', type=float, default=0.05, help='Threshold for box detection')
    parser.add_argument('--ocr_backend', type=str, default='vision', choices=['vision', 'easyocr', 'paddleocr'], help='OCR backend')
    parser.add_argument('--ocr_langs', type=str, default='ch_sim,en', help='Comma separated OCR languages, e.g. ch_sim,en')
